...
## Data for CIE
Pre-processed databases depicting interactions in human cells are available [here](http://markov.math.umb.edu/CIE).  Click the "Download files" button at the top of the page:
![Screenshot of the File Download Page](https://www.dropbox.com/s/9a77vxwcmd8vnbn/downloadFiles.png?dl=1)
